...
> Remontent aussi via le message `event` : OBS (`Obs.SceneChanged`/`StreamingStarted`/`StreamingStopped`) et Streamer.bot (`Pulsoid.HeartRatePulse` — forwardé brut pour le mode BPM local).
